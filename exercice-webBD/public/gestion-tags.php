...
if (!empty($_POST)) {
    try {
        ...
        }// Nous sommes dans le cas d'une demande de modification d'un tag (LA DEMANDE DE MODIFICATION)
        ...
        }// Nous sommes dans le cas de la modification d'un tag (LA MODIFICATION)
