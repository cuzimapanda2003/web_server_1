      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="gestion-tags.php">Gestion Tag</a></li>
              <li><a class="dropdown-item" href="gestion-tagjs.php">Gestion Tag (js)</a></li>
              <li><a class="dropdown-item" href="liste-blogues.php">Liste Blogue</a></li>
            </ul>
          </li>
